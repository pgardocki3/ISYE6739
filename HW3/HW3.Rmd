...
$\\\frac{\partial l}{\partial u} = 0 = \frac{n}{p}-\frac{\sum\limits_{i=1}^n x_i-n}{1-p} =\frac{n(1-p)-p\sum\limits_{i=1}^n x_i-n}{p(1-p)} = n-p\sum\limits_{i=1}^n x_i \therefore\\ p= \frac{n}{\sum\limits_{i=1}^n x_i}\\$
